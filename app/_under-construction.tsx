    ...
    <main className={styles.page}>
      ...
      <section className={styles.manifesto}>
        ...
        <div className={styles.manifestoText}>
          ...
          <p className={styles.reveal} data-reveal>
            Everything is chosen for what it produces in you. The conversation. The glass of
            wine. The weight of the vessel you&apos;re holding. The artwork on the wall. None
            of it is incidental.
          </p>
