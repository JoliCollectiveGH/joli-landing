...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: 'https://vzjcbnlsfkpigrdfrifx.supabase.co/storage/v1/object/public/Assets/social_austria.jpeg?v=2',
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    title: 'JOLI Collective — Trip Planning Concierge',
    description: 'A full-service trip planning concierge. Tell us where you want to go — we deliver a complete, bespoke plan within 24 hours.',
    images: ['https://vzjcbnlsfkpigrdfrifx.supabase.co/storage/v1/object/public/Assets/social_austria.jpeg?v=2'],
  },
  alternates: {
